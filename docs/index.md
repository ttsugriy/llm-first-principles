...
- **Code from scratch** — Every algorithm implemented with comprehensive test suites
- **First principles pedagogy** — Each concept builds only on what's already been covered
- **Historical context** — Learn who developed these ideas and why
...
| Stage | Topic | Sections | Status |
|-------|-------|----------|--------|
| 1 | [Markov Chains](stages/stage-01/index.md) | 10 sections + exercises | ✅ Complete |
| 2 | [Automatic Differentiation](stages/stage-02/index.md) | 7 sections | ✅ Complete |
| 3 | [Neural Language Models](stages/stage-03/index.md) | 7 sections | ✅ Complete |
| 4-18 | Optimization → Transformers → RLHF | — | Planned |
...
4. **Check solutions** — Compare your approach to reference solutions
