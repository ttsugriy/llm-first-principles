...
Solution: scale by input dimension.

$$W_{ij} \sim \mathcal{N}\left(0, \frac{1}{n_{\text{in}}}\right)$$

Or for uniform distribution:
$$W_{ij} \sim \text{Uniform}\left(-\sqrt{\frac{3}{n_{\text{in}}}}, \sqrt{\frac{3}{n_{\text{in}}}}\right)$$

Now:
$$\text{Var}(y_j) = n \cdot \frac{1}{n} \cdot \text{Var}(x) = \text{Var}(x)$$
